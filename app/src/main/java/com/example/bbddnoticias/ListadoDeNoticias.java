...
public class ListadoDeNoticias extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            adaptadorListView = new AdaptadorListView(this, listaNoticias);
